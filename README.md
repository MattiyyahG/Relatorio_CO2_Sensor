...
(No código acima, não foi incluido, mas para o funcionamento do mesmo, é necessário incluir e instalar a biblioteca respectiva ao sensor que será utilizado, tal qual: "MQ-2, MQ-3, MQ-135" e afins, sem a mesma, não haverá calibração e respectivamente não funcionará.)
